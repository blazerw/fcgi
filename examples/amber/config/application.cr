...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Amber World web application."
  #
  #
  ...
  #
  # settings.secret_key_base= jlbNkvM0qL6x38FmjNinPR53ywQ6EejDAxNP6EXQo0I
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("amber_world.log", "w"))
  #
  #
end
